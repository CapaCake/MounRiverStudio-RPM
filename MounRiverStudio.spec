...
Source0:        %{name}_Linux_X64_V%{version}.tar.xz
...
%prep
%setup -q -c -n %{name}_Linux_X64_V%{version}
...
cp -r %{_builddir}/%{name}_Linux_X64_V%{version}/usr/share/* %{buildroot}/usr/share/

mkdir -p %{buildroot}/etc/udev/rules.d/
cp %{_builddir}/%{name}_Linux_X64_V%{version}/usr/share/MRS2/beforeinstall/50-wch.rules %{buildroot}/etc/udev/rules.d/
cp %{_builddir}/%{name}_Linux_X64_V%{version}/usr/share/MRS2/beforeinstall/60-openocd.rules %{buildroot}/etc/udev/rules.d/
